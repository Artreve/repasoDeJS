...
let carrito = new Set();
carrito.add('Camisa');//Agregar elementos 
carrito.add('Disco #1');
carrito.add('Disco #2');
carrito.add('Disco #3');
carrito.add('Disco #3');//Si se repite, no se carga
console.log(carrito.size);


// En un arreglo
let numeros = new Set([1,2,3,4,5,6,7,3,3,3,3]);
console.log(numeros.size);//Tamaño del arreglo
...
// Eliminando del set
console.log( carrito.delete('Camisa') );//si queremos saber el valor de la operacion, nos dara un boolean
